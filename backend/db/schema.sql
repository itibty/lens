...
(201, 2, '编辑用户', 'FUNC', NULL, NULL, 2, 'sys:user:write', 'EBL'),
(202, 2, '配置角色', 'FUNC', NULL, NULL, 3, 'sys:user:config-role', 'EBL'),
(203, 2, '重置密码', 'FUNC', NULL, NULL, 4, 'sys:user:pwd', 'EBL'),
(300, 3, '查看角色', 'FUNC', NULL, NULL, 1, 'sys:role:query', 'EBL'),
(301, 3, '编辑角色', 'FUNC', NULL, NULL, 2, 'sys:role:write', 'EBL'),
(302, 3, '配置功能', 'FUNC', NULL, NULL, 3, 'sys:role:config-menu', 'EBL'),
(303, 3, '配置看板', 'FUNC', NULL, NULL, 4, 'sys:role:config-dashboard', 'EBL'),
(400, 4, '查看菜单', 'FUNC', NULL, NULL, 1, 'sys:menu:query', 'EBL'),
(401, 4, '编辑菜单', 'FUNC', NULL, NULL, 2, 'sys:menu:write', 'EBL'),
(1100, 11, '查看数据集', 'FUNC', NULL, NULL, 1, 'ds:sql:conf', 'EBL'),
(1101, 11, '编辑数据集', 'FUNC', NULL, NULL, 2, 'ds:sql:conf', 'EBL'),
(1700, 17, '查看卡片', 'FUNC', NULL, NULL, 1, 'ds:card:query', 'EBL'),
(1701, 17, '编辑卡片', 'FUNC', NULL, NULL, 2, 'ds:card:write', 'EBL'),
(1800, 18, '查看看板', 'FUNC', NULL, NULL, 1, 'ds:dashboard:query', 'EBL'),
(1801, 18, '编辑看板', 'FUNC', NULL, NULL, 2, 'ds:dashboard:write', 'EBL');
