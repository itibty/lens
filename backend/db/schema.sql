...
INSERT INTO `sys_menu` (`id`, `pid`, `menu_name`, `menu_type`, `route_path`, `icon`, `sort_num`, `perm_code`, `status`, `create_at`, `create_by`, `modify_at`, `modify_by`) VALUES (2,20,'用户','MENU','/sys/users',NULL,10,NULL,'EBL',NULL,NULL,1789898116807,NULL);
INSERT INTO `sys_menu` (`id`, `pid`, `menu_name`, `menu_type`, `route_path`, `icon`, `sort_num`, `perm_code`, `status`, `create_at`, `create_by`, `modify_at`, `modify_by`) VALUES (3,20,'角色','MENU','/sys/roles',NULL,20,NULL,'EBL',NULL,NULL,1789898116807,NULL);
INSERT INTO `sys_menu` (`id`, `pid`, `menu_name`, `menu_type`, `route_path`, `icon`, `sort_num`, `perm_code`, `status`, `create_at`, `create_by`, `modify_at`, `modify_by`) VALUES (4,20,'菜单','MENU','/sys/menus',NULL,30,NULL,'EBL',NULL,NULL,1789898116807,NULL);
INSERT INTO `sys_menu` (`id`, `pid`, `menu_name`, `menu_type`, `route_path`, `icon`, `sort_num`, `perm_code`, `status`, `create_at`, `create_by`, `modify_at`, `modify_by`) VALUES (11,21,'数据集','MENU','/vis/datasets',NULL,30,NULL,'EBL',NULL,NULL,1789898116807,NULL);
...
INSERT INTO `sys_menu` (`id`, `pid`, `menu_name`, `menu_type`, `route_path`, `icon`, `sort_num`, `perm_code`, `status`, `create_at`, `create_by`, `modify_at`, `modify_by`) VALUES (17,21,'卡片','MENU','/vis/cards',NULL,10,NULL,'EBL',NULL,NULL,1789898116807,NULL);
INSERT INTO `sys_menu` (`id`, `pid`, `menu_name`, `menu_type`, `route_path`, `icon`, `sort_num`, `perm_code`, `status`, `create_at`, `create_by`, `modify_at`, `modify_by`) VALUES (18,21,'看板','MENU','/vis/dashboards',NULL,20,NULL,'EBL',NULL,NULL,1789898116807,NULL);
...
INSERT INTO `sys_menu` (`id`, `pid`, `menu_name`, `menu_type`, `route_path`, `icon`, `sort_num`, `perm_code`, `status`, `create_at`, `create_by`, `modify_at`, `modify_by`) VALUES (19,21,'数据源','MENU','/vis/datasources',NULL,35,NULL,'EBL',NULL,NULL,1789898116807,NULL);
...
INSERT INTO `vis_card` (`id`, `card_name`, `card_desc`, `dataset_id`, `chart_type`, `query_json`, `visual_json`, `status`, `create_at`, `create_by`, `modify_at`, `modify_by`) VALUES (9222,'区域营收成本对比','本月各大区',9101,'bar','{\"filters\": [{\"combineOp\": \"and\", \"conditions\": [{\"field\": \"order_date\", \"valueExp\": \"current_month\"}]}], \"metrics\": [{\"agg\": \"SUM\", \"field\": \"revenue\", \"label\": \"营收\"}, {\"agg\": \"SUM\", \"field\": \"cost\", \"label\": \"成本\"}], \"asOfDate\": \"2026-06-15\", \"datasetId\": \"9101\", \"orderList\": [{\"dir\": \"desc\", \"field\": \"营收\"}], \"dimensions\": [{\"field\": \"region\", \"label\": \"区域\"}]}','{\"chartType\": \"bar\", \"chart\": {\"orientation\": \"horizontal\", \"stacked\": false}, \"showTitle\": true, \"allowDetail\": true}','EBL',NULL,NULL,NULL,NULL);
